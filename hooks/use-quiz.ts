...
interface UseQuizReturn {
  ...
  getAllQuestions: () => Array<{type: 'true_false' | 'multiple_choice', question: TrueFalseQuestion | MultipleChoiceQuestion, index: number}>
}
...
export function useQuiz(): UseQuizReturn {
  ...
  const getAllQuestions = useCallback(() => {
    ...
    state.quiz.true_false_questions.forEach((q, idx) => {
      questions.push({
        type: 'true_false',
        question: q,
        index: idx
    ...
    state.quiz.multiple_choice_questions.forEach((q, idx) => {
      questions.push({
        type: 'multiple_choice',
        question: q,
        index: state.quiz!.true_false_questions.length + idx
      })
    })
